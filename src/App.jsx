                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 overflow-visible pb-1">
                      <button
                        ...
                        className="flex lg:w-84 min-w-44 shrink-0 items-center justify-between rounded-2xl border border-slate-300 bg-white px-4 py-3 text-left text-sm text-slate-900 transition hover:border-slate-400"
                      >
                          ...
                          <div className="grid grid-cols-5 gap-1.5 sm:grid-cols-7 md:grid-cols-9 lg:grid-cols-10 xl:grid-cols-12">
                            {progress[book.name].map((isRead, index) => (
                              <div
                                ...
                                className={`flex items-center gap-5 rounded-xl border px-1.5 py-1 text-xs transition hover:shadow-sm ${
                                  isRead
